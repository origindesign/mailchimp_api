...
namespace Drupal\mailchimp_api;

use Drupal\mailchimp_api\http\MailchimpCurlHttpClient;
use Drupal\mailchimp_api\http\MailchimpGuzzleHttpClient;
use Drupal\mailchimp_api\http\MailchimpHttpClientInterface;
...
class Mailchimp {
   ...
   */
  public function connection($api_key, $api_user = 'apikey', $http_options = [], MailchimpHttpClientInterface $client = NULL) {
